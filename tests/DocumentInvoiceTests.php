...
test('GetInvoiceStatesHistory', function (string $medidocDocumentGID) {
    expect(GetDocumentStatesHistory::run($medidocDocumentGID))
...
test('GetDocumentContent', function (string $medidocDocumentGID) {
...
})->depends('GetInvoiceStatesHistory');


test('CompleteDocument', function (string $medidocDocumentGID) {

    expect(CompleteDocument::run($medidocDocumentGID, now()))
...
test('CancelDocument', function (string $medidocDocumentGID) {

    expect(CancelDocument::run($medidocDocumentGID))
        ->toBeInstanceOf(GenericResponse::class);
